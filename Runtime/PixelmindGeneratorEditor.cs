...
namespace PixelmindImaginarium
{
    ...
    public class PixelmindGeneratorEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            // FindObjectOfType<PusherManager>().InitialisePusher();
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            // if (pusherManager)
            // {
            //     pusherManager.CheckIfAssetsReady();
            // }
            ...
            if (showGenerators)
            {
                ...
                {
                    pixelmindGenerator.GetGeneratorsWithFields();
                }

                // Iterate over generator fields and render them in the GUI
                if (!EditorApplication.isPlayingOrWillChangePlaymode && pixelmindGenerator.generatorFields.Count > 0)
                {
            ...
            if (showGenerationButtons)
            {
                ...
                else
                {
                    ...
                    {
                        pixelmindGenerator.InitializeGeneration(
