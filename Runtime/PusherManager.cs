...
public class PusherManager : MonoBehaviour
{
    ...
    public async Task InitialisePusher()
    {
        ...
        if (_pusher == null && (APP_KEY != "APP_KEY") && (APP_CLUSTER != "APP_CLUSTER"))
        {
            ...
            _channel = await _pusher.SubscribeAsync("api_client_status_update_RSlmi_8yxgbBO0ZevBgNveEGhMLjHWpQr7yatY");
    ...
    private void PusherOnConnected(object sender)
    {
        ...
        {
            Debug.Log("status_update received");
            ...
            Debug.Log(pusherResponseData.status);
