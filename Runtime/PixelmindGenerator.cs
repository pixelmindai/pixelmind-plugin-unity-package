...
public class PixelmindGenerator : MonoBehaviour
{
    ...
    private void RenderInGameFields()
    {
        ...
        if (GUILayout.Button("Generate"))
        {
            ...
            InitializeGeneration(generatorFields, generators[generatorOptionsIndex].generator, true);
        }
    }
    ...
    {
        Debug.Log("test GetGeneratorsWithFields");
        
        // Make API call and store response data in variable
    ...
    {
        Debug.Log("test GetGeneratorFields");
        ...
        Debug.Log(generatorFields.Count);
    }
    ...
    private void SaveAssets(Texture2D texture, Sprite sprite, string prompt)
    {
        ...
        while (true)
        {
            ...
            Debug.Log(textureAssets.Length);
